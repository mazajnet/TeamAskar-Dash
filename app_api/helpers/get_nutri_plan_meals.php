<?php
	...
	$qu_customers_nutrition_diets_sel = "SELECT * FROM  `customers_nutrition_diets_meals` WHERE `nutrition_plan_id` = $nutrition_plan_id";
	...
	$IAM_ARRAY['success'] = true;
		while( $ARRAY_SRC = mysqli_fetch_assoc($qu_customers_nutrition_diets_EXE) ){
			...
			$IAM_ARRAY['result'][] = array( "meal_name" => $ARRAY_SRC['meal_name'], 
