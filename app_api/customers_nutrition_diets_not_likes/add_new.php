...
if( isset($_POST['item_name']) &&
	...
	$qu_customers_nutrition_diets_not_likes_ins = "INSERT INTO `customers_nutrition_diets_not_likes` (
						`item_name`, 
						`nutrition_plan_id`, 
						`customer_id` 
					) VALUES (
	...
	if(mysqli_query($KONN, $qu_customers_nutrition_diets_not_likes_ins)){
