...
$IAM_ARRAY['success'] = false;
	...
	$qu_customers_nutrition_diets_likes_sel = "SELECT * FROM  `customers_nutrition_diets_likes` WHERE `nutrition_plan_id` = $nutrition_plan_id";
	$qu_customers_nutrition_diets_likes_EXE = mysqli_query($KONN, $qu_customers_nutrition_diets_likes_sel);
	
	if( mysqli_num_rows($qu_customers_nutrition_diets_likes_EXE) > 0 ){
$IAM_ARRAY['success'] = true;
	
		while( $ARRAY_SRC = mysqli_fetch_assoc($qu_customers_nutrition_diets_likes_EXE) ){
