...
if( isset($_POST['supplement_id']) &&
	...
	$qu_customers_nutrition_diets_supplement_ins = "INSERT INTO `customers_nutrition_diets_supplement` (
						`supplement_id`, 
						`supplement_name`, 
						`comments`, 
						`added_date`, 
	...
	if(mysqli_query($KONN, $qu_customers_nutrition_diets_supplement_ins)){
