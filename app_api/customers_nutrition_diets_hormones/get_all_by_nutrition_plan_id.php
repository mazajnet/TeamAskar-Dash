...
$IAM_ARRAY['success'] = false;
	...
	$qu_customers_nutrition_diets_hormones_sel = "SELECT * FROM  `customers_nutrition_diets_hormones` WHERE `nutrition_plan_id` = $nutrition_plan_id";
	$qu_customers_nutrition_diets_hormones_EXE = mysqli_query($KONN, $qu_customers_nutrition_diets_hormones_sel);
	
	if( mysqli_num_rows($qu_customers_nutrition_diets_hormones_EXE) > 0 ){
	
$IAM_ARRAY['success'] = true;
		while( $ARRAY_SRC = mysqli_fetch_assoc($qu_customers_nutrition_diets_hormones_EXE) ){

			$IAM_ARRAY['result'][] = array(  "record_id" => $ARRAY_SRC['record_id'], 
									"hormone_id" => $ARRAY_SRC['hormone_id'], 
									"hormone_name" => $ARRAY_SRC['hormone_name'], 
