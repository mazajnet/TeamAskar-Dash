...
if( isset($_POST['record_id']) ){
	...
	if( $qqq != "" ){
		$qqq =  substr($qqq, 0, -2);
		$qu_customers_nutrition_diets_not_likes_updt = "UPDATE  `customers_nutrition_diets_not_likes` SET ".$qqq."  WHERE `record_id` = $record_id;";

		if(mysqli_query($KONN, $qu_customers_nutrition_diets_not_likes_updt)){
