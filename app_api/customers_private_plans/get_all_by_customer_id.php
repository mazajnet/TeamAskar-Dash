...
$IAM_ARRAY['success'] = false;
	...
	$qu_customers_private_plans_sel = "SELECT * FROM  `customers_private_plans` WHERE `customer_id` = $customer_id";
	$qu_customers_private_plans_EXE = mysqli_query($KONN, $qu_customers_private_plans_sel);
	
	if( mysqli_num_rows($qu_customers_private_plans_EXE) > 0 ){
$IAM_ARRAY['success'] = true;
		while( $ARRAY_SRC = mysqli_fetch_assoc($qu_customers_private_plans_EXE) ){
