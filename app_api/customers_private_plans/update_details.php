...
if( isset($_POST['private_plan_id']) ){
	...
	if( $qqq != "" ){
		$qqq =  substr($qqq, 0, -2);
		$qu_customers_private_plans_updt = "UPDATE  `customers_private_plans` SET ".$qqq."  WHERE `private_plan_id` = $private_plan_id;";

		if(mysqli_query($KONN, $qu_customers_private_plans_updt)){
